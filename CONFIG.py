# Channel IDs
CHANNEL_ID: int = 607838204468658188  # Eternity Onmyoji
...
PR_STATUES = ['with fire', 'with myself ( ͡° ͜ʖ ͡°)', 'dead', 'hard to get', 'with sharp objects', 'with your heart',
              'with your feeling', 'with the dark arts', 'a prank on you', 'with a noose', 'God', 'the objective',
              'Half-Life 3']
